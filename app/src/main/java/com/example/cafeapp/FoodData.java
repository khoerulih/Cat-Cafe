...
public class FoodData {
    ...
    private static String[] foodDescriptions = {
            ...
            "Soarkling Tea pada dasarnya adalah campuran soda dan teh, versi klasik yang sehat dan berkarbonasi—dan para ahli kesehatan menyukainya. “Minuman ini bisa memberikan manfaat teh di dalamnya,” ujar Jessica Cording, R.D."
    };
    ...
    private static int[] foodThumbnails = {
            R.drawable.batagor,
    ...
    static ArrayList<Food> getListData() {
        ...
        for (int position = 0; position < foodNames.length; position++) {
            ...
            food.setDescription(foodDescriptions[position]);
            food.setPrice(foodPrices[position]);
            food.setThumbnail(foodThumbnails[position]);
            list.add(food);
        }
        return list;
    }
